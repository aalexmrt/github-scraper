...
echo "📋 Production Logs - Quick Reference"
echo "===================================="
echo ""
echo "1️⃣  View API Logs (Recent):"
echo "   ./view-prod-logs.sh api"
echo ""
echo "2️⃣  View Worker Logs (Recent):"
echo "   ./view-prod-logs.sh worker"
echo ""
echo "3️⃣  View Both (Recent):"
echo "   ./view-prod-logs.sh both"
echo ""
echo "4️⃣  Stream API Logs (Live):"
echo "   ./view-prod-logs.sh api --tail"
echo ""
echo "5️⃣  Stream Worker Logs (Live):"
echo "   ./view-prod-logs.sh worker --tail"
echo ""
echo "6️⃣  View Errors Only:"
echo "   ./view-prod-logs.sh errors"
echo ""
echo "7️⃣  Manual Commands:"
echo ""
